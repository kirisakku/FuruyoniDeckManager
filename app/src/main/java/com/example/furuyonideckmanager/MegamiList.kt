...
fun readFile(thisArg: RandomChooseActivity): List<List<String>> {
...
fun getList(thisArg:RandomChooseActivity, checkedMegami: MutableList<String>): MutableList<Map<String, String>> {
